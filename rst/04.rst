...
.. [#] NT: También se conoce como *"Tail Call"*, y en español sería algo así 
   como: *"Recurción por cola"*, o *"Recurción al reves"*.

Considere la siguiente función para calcular el Máximo Común Divisor de dos 
números dados.
...
(_Recursión por colas_). La llamada final en una función de recursión por 
...
espacio en la pila (_Stack_). Por lo tanto, las funciones de recursión por 
